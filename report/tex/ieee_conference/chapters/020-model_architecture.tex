...
The ViT model has approximately \textit{85 million} parameters, but only \textit{9,228} of them are trainable. This makes the model computationally efficient while still benefiting from the powerful feature extraction capabilities of the pre-trained ViT model.
